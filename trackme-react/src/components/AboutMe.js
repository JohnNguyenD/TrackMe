  ...
  return (
    <div>
      ...
      <div className="main">
        <h1>John Nguyen</h1>
        <p>
          My hobbies are learning new things and listening music in the free
          time
        </p>
        ...
        <section>
          ...
          <ol>
            ...
            <li>Hello that's awesome</li>
            <li>SIT232 OBJECT-ORIENTED DEVELOPMENT</li>
            <li>SIT190 INTRODUCTORY MATHEMATICAL METHODS</li>
            <li>
              SIT107 SOFTWARE ENGINEERINGS 1: CONNECTING THE CYBER AND PHYSICAL
              WORLDS
            </li>
